...
WebUI.setText(findTestObject('Objects-Login success/Page_ProjectBackend/input_username'), user)

WebUI.setText(findTestObject('Objects-Login success/Page_ProjectBackend/input_password'), pass)
